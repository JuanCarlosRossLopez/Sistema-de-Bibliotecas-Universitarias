                ...
                <div className="relative flex h-16 items-center justify-stretch">
                    ...
                    <div className="flex-col pe-2 md:pe-24 md:ps-10 xl:pe-64">
                        <div className="flex shrink-0 items-center">
                            <img className="h-20 w-20" src="public\img\logoNegro.svg" alt="Your Company" />
                            <p className="font-serif text-base md:text-lg lg:text-xl xl:text-4xl text-black pl-3">Big Library</p>
                        </div>
                    </div>
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex py-6">
                                <a href="" className="px-3 py-2 lg:text-3xl md:text-xl sm:text-lg font-serif text-black transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" aria-current="page">Inicio</a>
                                <div className="h-13 w-0.5 bg-slate-200"></div>
                                <a href="#" className="px-6 py-2 lg:text-3xl md:text-xl sm:text-lg text-black font-serif transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">Catalogo</a>
                                <div className="h-13 w-0.5 bg-slate-200"></div>
                                <a href="#" className="px-4 py-2 lg:text-3xl md:text-xl sm:text-lg text-black font-serif transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">Acerda de</a>
                            </div>
                        </div>
                    </div>
