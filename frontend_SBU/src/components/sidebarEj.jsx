    ...
    return (
        <div id="containerSidebar" className="z-40">
            <div className="navbar-menu relative z-40">
                <nav
                    id="sidebar"
                    className="fixed left-0 top-0 bottom-0 flex w-3/5 -translate-x-full sm:max-w-xs lg:w-80 flex-col overflow-y-auto bg-[#A2726A] pt-6 pb-8 transition-transform"
                >
