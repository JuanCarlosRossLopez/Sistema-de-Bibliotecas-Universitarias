      ...
      <div className="mx-auto max-w-8xl px-2 sm:px-6 lg:px-12">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-start sm:hidden">
            <button
              type="button"
              className="inline-flex items-center justify-stard rounded-md p-2  text-white hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
          ...
          <div className="flex items-center">
            <img
              className="h-20 w-20"
              src="public/img/logoBlanco 2.svg"
              alt="Logo"
            />
            <p className="font-serif text-base md:text-lg lg:text-xl xl:text-4xl text-white pl-3">
              Big Library
            </p>
          </div>
