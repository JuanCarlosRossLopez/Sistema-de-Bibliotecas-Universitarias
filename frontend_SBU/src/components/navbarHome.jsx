            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex py-6">
                    ...
                    <div className="h-13 w-0.5 bg-slate-200"></div>
                    <a href="#" class=" px-4 py-2 lg:text-3xl md:text-xl sm:text-lg text-white font-serif transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">Acerda de</a>
                </div>
              </div>
            </div>
