  ...
  return (
    <div className="h-screen w-full relative">
      ...
      <div className="flex items-center justify-center mt-5  sm:py-10">
        <div className="bg-[#C19B93] border-[4px] border-yellow-900 rounded-2xl hover:border-yellow-600 transition-all duration-200 w-full max-w-xl mx-4 sm:mx-6 lg:mx-10">
          <form
